    ...
    def statement(self):
        if self.match_type == sepol.FILENAME_TRANS_MATCH_EXACT:
            return "{0.ruletype} {0.source} {0.target}:{0.tclass} {0.default} {0.filename};". \
                format(self)
        if self.match_type == sepol.FILENAME_TRANS_MATCH_PREFIX:
            return "{0.ruletype} {0.source} {0.target}:{0.tclass} {0.default} {0.filename} prefix;". \
                format(self)
        if self.match_type == sepol.FILENAME_TRANS_MATCH_SUFFIX:
            return "{0.ruletype} {0.source} {0.target}:{0.tclass} {0.default} {0.filename} suffix;". \
                format(self)
